        ...
        <div className="container-fluid px-5">
          <div className="d-flex flex-column flex-lg-row align-items-center justify-content-between">
            ...
            <div className="d-flex flex-column align-items-lg-end align-items-center">
                ...
                {menuItems.map((item: any) => (
                  <li className="list-inline-item px-2" key={item.id}>
                    <Link
                      ...
                      className="text-secondary hover-effect-1 text-decoration-none text-capitalize"
                    >
                      {item.title}
                    </Link>
                  </li>
              ...
              {/* Copyright */}
              <p
                className="text-secondary m-0 text-center text-lg-end"
                style={{ fontSize: "0.85rem" }}
              >
                © 2026 Micro Sitio Dirección General de Asuntos Culturales y
                Patrimoniales - Legislatura de la Ciudad Autónoma de Buenos
                Aires +549 11 43384059{" "}
                <Link
                  href="/contacto"
