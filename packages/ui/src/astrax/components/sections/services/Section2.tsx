...
export default function Section2() {
    return (
        <>
            {/*business-services section 2*/}
            <section className="business-services-section-2 position-relative overflow-hidden py-120 bg-primary">
                    ...
                    <div className="row">
                        <div className="text-center">
                            <span className="d-flex align-items-center justify-content-center gap-2">
                                ...
                                <span className="text-white btn-text">Pricing Plan</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width={18} height={2} viewBox="0 0 18 2" fill="none">
                                    <circle cx={1} cy={1} r={1} fill="white" />
                                    <circle opacity="0.5" cx={9} cy={1} r={1} fill="white" />
                                    <circle opacity="0.2" cx={17} cy={1} r={1} fill="white" />
                                </svg>
                            </span>
                            <h2 className="text-white mb-0 text-anime-style-2">Our Awesome Pricing Plans</h2>
                        </div>
                    </div>
                    <div className="row mt-4 mb-6">
                        <div className="d-flex flex-wrap align-items-center justify-content-center gap-md-5 gap-2 overflow-hidden">
                            <div className="d-flex align-items-center gap-3" data-aos="fade-up" data-aos-delay={200}>
                                <div className="d-block">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" fill="none">
                                        <g clipPath="url(#clip0_349_1213)">
                                            <path d="M13.9476 4.03755C13.8717 3.96164 13.7721 3.92368 13.6723 3.92368C13.5727 3.92368 13.473 3.96161 13.3971 4.03751C13.2453 4.18932 13.2453 4.43632 13.3971 4.58809C13.5489 4.73997 13.7959 4.7399 13.9476 4.58809C14.0211 4.51455 14.0616 4.41678 14.0616 4.31278C14.0617 4.20886 14.0212 4.11109 13.9476 4.03755Z" fill="white" />
                                            <path d="M7.50275 9.75126C7.39735 9.64586 7.29782 9.59485 7.20403 9.59794C7.11026 9.60114 7.017 9.64902 6.92429 9.74177L6.61133 10.0547L7.19928 10.6427L7.51224 10.3297C7.60495 10.237 7.65287 10.1438 7.65606 10.05C7.65923 9.95625 7.60815 9.85669 7.50275 9.75126Z" fill="white" />
                                            <path
                                ...
                                <p className="text-white mb-0">Get 30 day free trial</p>
                            </div>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" fill="none">
                                        <g clipPath="url(#clip0_349_1230)">
                                            ...
                                            <path
                                                ...
                                                fill="white"
                                            />
                                            <path d="M6.85529 0.760009C6.21038 0.28459 5.41507 0 4.55239 0C2.40394 0 0.662109 1.74186 0.662109 3.89028C0.662109 4.41838 0.768247 4.92158 0.95913 5.38052C2.1535 3.0947 4.29212 1.3847 6.85529 0.760009Z" fill="white" />
                                            <path d="M17.0404 5.38055C17.2312 4.92131 17.3374 4.4181 17.3374 3.89031C17.3377 1.74186 15.5959 0 13.4474 0C12.5841 0 11.7894 0.28459 11.1445 0.76061C13.7074 1.38498 15.846 3.09531 17.0404 5.38055Z" fill="white" />
                                        </g>
                                    </svg>
                                </div>
                                <p className="text-white mb-0">You can cancel anytime</p>
                            </div>
                        </div>
                    </div>
                    <div className="row g-4 mt-3">
                        <div className="col-lg-4">
                            <div className="card-pricing bg-white rounded-4 border p-md-6 p-4" data-aos="fade-up" data-aos-delay={0}>
                                ...
                                <Link href="/pricing" className="btn btn-outline-dark w-100 mb-6 button--calypso">
                                ...
                                <ul className="list-unstyled mt-3 mb-0">
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                                        ...
                                        <img src="assets/imgs//template/icons/check.svg" alt="AstraX" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                        ...
                        <div className="col-lg-4">
                            <div className="card-pricing bg-white rounded-4 border border-primary p-md-6 p-4 position-relative" data-aos="fade-up" data-aos-delay={200}>
                                ...
                                <p className="fs-7">Best for small business owners, startups who needes landing page.</p>
                                <Link href="/pricing" className="btn btn-primary border-dark w-100 mb-6 button--calypso">
                                    <span>try for free</span>
                                </Link>
                                <span className="btn-text">What’s included:</span>
                                <ul className="list-unstyled mt-3 mb-0">
