                            ...
                            <div className="row pt-120 pb-120 g-lg-0 g-5">
                                <div className="col-lg-2">
                                    <Link href="/" className="text-center text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={190} height={190} viewBox="0 0 40 40" fill="none">
                                            <g>
                                        ...
                                        <h5 className="text-white">Astrax</h5>
                                    </Link>
                                </div>
                                <div className="col-lg-6 ps-lg-5">
                                    <h2 className="stroke text-dark-2 text-start pb-2 mb-0 text-anime-style-2">Let’s catchup us</h2>
                                    <h2 className="text-white text-start text-anime-style-2">great work together.</h2>
                                    <div className="d-flex flex-wrap gap-md-5 gap-4 mt-7">
                                        <div className="d-flex align-items-center wow fadeInUp2" data-wow-delay=".4s">
                                            <div>
                                                <Link href="#" className="me-3">
                                                    <img src="assets/imgs/pages/coworking-space/page-home/footer/telephone.png" alt="AstraX" />
                                                </Link>
                                            </div>
                                            <div>
                                                <Link href="#" className="text-white fs-20 fw-bold">
                                                    +(123) 456 789 00
                                                </Link>
                                                <p className="mb-0">Phone number</p>
                                            </div>
                                        </div>
                                        <div className="d-flex align-items-center wow fadeInUp2" data-wow-delay=".8s">
                                            <div>
                                                <Link href="#" className="me-3">
                                                    <img src="assets/imgs/pages/coworking-space/page-home/footer/tele.png" alt="AstraX" />
                                                </Link>
                                            </div>
                                            <div>
                                                <Link href="#" className="text-white fs-20 fw-bold">
