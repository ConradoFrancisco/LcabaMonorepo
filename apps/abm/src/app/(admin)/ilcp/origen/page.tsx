...
export default function BneficiosPage() {
  ...
  return (
    <>
      <ComponentCard title="Ilcp Origen inscripto">
        <Search setSearch={setSearch} tipo={'docentes'} setOffset={setOffset} />
        <TableComponent
          data={data}
          loading={loading}
          total={total}
