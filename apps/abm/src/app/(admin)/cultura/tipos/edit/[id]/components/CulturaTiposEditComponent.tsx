...
export default function CulturaTiposEditComponent({ response }: { response: TypeResponse }) {
  const {
    title,
    tipo,
    titulo,
  ...
  return (
    <EditComponent
      ...
      tituloCard="Editar Tipo de Publicaciones - Cultura"
    />
  );
}
