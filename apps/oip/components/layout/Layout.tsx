...
export default function Layout({ headerStyle, footerStyle, breadcrumbTitle, children, menuItems = [], pageVw = [], logo }: LayoutProps) {
	...
	return (
		<>
			<div id="top" />
			<BootstrapComponents />
			<Header scroll={scroll} isMobileMenu={isMobileMenu} handleMobileMenu={handleMobileMenu} menuItems={menuItems} logo={logo} />
